...
const interfaceText = {
  en: {
    ...
    hadithLoadFailed: "This hadith could not be loaded.",
    hadithNotImported: "has not been imported yet",
    hadithNumberRange: "Hadith numbers run from 1 to 16,546. This number is not yet present in the library.",
    previousHadith: "Previous hadith",
    nextHadith: "Next hadith",
    hadithNavigation: "Hadith navigation",
    fullEntry: "Full entry",
    noBengaliTranslation: "A Bengali translation has not yet been added for this hadith.",
  },
  bn: {
    settings: "সেটিংস",
    ...
    hadithLoadFailed: "এই হাদিসটি লোড করা যায়নি।",
    hadithNotImported: "এখনও যোগ করা হয়নি",
    hadithNumberRange: "হাদিস নম্বর ১ থেকে ১৬,৫৪৬ পর্যন্ত। এই নম্বরটি এখনও গ্রন্থাগারে নেই।",
    previousHadith: "পূর্ববর্তী হাদিস",
    nextHadith: "পরবর্তী হাদিস",
    hadithNavigation: "হাদিস নেভিগেশন",
    fullEntry: "সম্পূর্ণ এন্ট্রি",
    noBengaliTranslation: "এই হাদিসের বাংলা অনুবাদ এখনো যোগ করা হয়নি।",
  },
} as const;
